...
<html>
<head>
	<title>Laporan Pengeluaran {{$formattedTanggal}}</title>
	<!-- Bootstrap CSS -->
...
<div style="margin-top:-30px; margin-bottom:-20px">
	...
	<p style="font-size:18px; font-family: 'Arial', sans-serif;font-weight: bold;text-align: center;"><u style="border-bottom: 2px solid #000;">LAPORAN DATA PENGELUARAN</u></p>
	...
	<table border="1" cellpadding="3" cellspacing="0" width="100%" style="font-size:13px; font-family: 'Arial', sans-serif;">
		<thead>
			<tr style="background-color: #1b00ff; color: white;">
              ...
              <th>Keterangan</th>
              <th class="text-center" width="20%">Metode Pengeluaran</th>
        ...
        <tfoot>
          ...
          ?>
        	<tr style="background-color: #1b00ff; color: white;">
        		<th colspan="4">Total Pengeluaran {{$data->nama}}</th>
