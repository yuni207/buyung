            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <select class="form-control" required name="level">
                     ...
                     <option value="1" @if($account->level == '1') selected @endif>Owner</option>
                     <option value="2" @if($account->level == '2') selected @endif>Kasir</option>
                     <option value="3" @if($account->level == '3') selected @endif>Operator</option>
                  </select>
               </div>
            </div>
            <div class="col-md-4">
