...
<html>
<head>
	<title>Laporan Piutang {{$label}}</title>
	<!-- Bootstrap CSS -->
...
<div style="margin-top:-30px; margin-bottom:-20px">
	...
	<p style="font-size:18px; font-family: 'Arial', sans-serif;font-weight: bold;text-align: center;"><u style="border-bottom: 2px solid #000;">LAPORAN DATA PIUTANG</u></p>
	...
	<table border="1" cellpadding="3" cellspacing="0" width="100%" style="font-size:12px; font-family: 'Arial', sans-serif;">
        ...
        <tfoot>
        	<tr style="background-color: #1b00ff; color: white;">
        		<th colspan="6">Total Piutang Keseluruhan</th>
                <th align="left">{{ 'Rp ' . number_format($totalKeseluruhan, 0, ',', '.') }}</th>
        	</tr>
        	<tr style="background-color: #1b00ff; color: white;">
        		<th colspan="6">Total Belum Kembali</th>
